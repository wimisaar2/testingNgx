...
function config ($routeProvider) {
    $routeProvider.
        ...
        .when('/surgeryPlanning', {
            templateUrl: 'sections/surgeryPlanning/surgeryPlanning.tpl.html',
            controller: 'SurgeryPlanningController as vm'
        }) 
        /*
        when('/', {
        ...
        .when('/demographic', {
            templateUrl: 'sections/demographic/demographic.tpl.html',
            controller: 'DemographicController as demographic'
        })
        .otherwise({
            redirectTo: '/'
        });
